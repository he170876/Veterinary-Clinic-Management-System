...
/**
 * Handles POST from receptionist change-password form.
 */
@WebServlet(name = "ReceptionistChangePasswordServlet", urlPatterns = {"/Receptionist/change-password"})
public class ReceptionistChangePasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String redirect = ctx + "/Receptionist/profile";
