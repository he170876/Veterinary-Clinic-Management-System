...
/**
 * Same change-password flow as customer, but for veterinarians under /vet/profile.
 */
@WebServlet(name = "VetChangePasswordServlet", urlPatterns = {"/vet/change-password"})
public class VetChangePasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String redirect = ctx + "/vet/profile";
