...
/**
 * Change-password flow for lab staff, same rules as vet/customer.
 */
@WebServlet(name = "LabChangePasswordServlet", urlPatterns = {"/lab/change-password"})
public class LabChangePasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String redirect = ctx + "/lab/profile";
