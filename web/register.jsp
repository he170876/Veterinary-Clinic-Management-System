...
<div class="flex flex-col lg:flex-row w-full min-h-screen">
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 md:p-20 bg-white">
        <div class="w-full max-w-[440px]">
            ...
            <!-- Google Sign Up -->
            <a href="<%= request.getContextPath() %>/google-login" class="w-full h-12 flex items-center justify-center gap-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors font-semibold text-gray-700 mb-6 no-underline">
