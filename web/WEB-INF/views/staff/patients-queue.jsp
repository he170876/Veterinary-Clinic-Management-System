...
<script>
    (function() {
        var toggle = document.getElementById('staff-profile-toggle');
        var menu = document.getElementById('staff-profile-menu');
