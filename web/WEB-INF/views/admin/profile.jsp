...
<%
    ...
    String roleTitle = (user.getRole() != null && user.getRole().getRoleName() != null) ? user.getRole().getRoleName() : "Admin";
...
<head>
    ...
    <title>Admin Profile - Anipats</title>
...
<div class="flex h-screen overflow-hidden">
        ...
        <div class="p-6 flex flex-col h-full">
            <div class="space-y-8">
                ...
                <nav class="flex flex-col gap-2">
                    <a class="bg-primary text-white flex items-center gap-3 px-4 py-3 rounded-full transition-all shadow-sm"
    ...
    <main class="flex-1 flex flex-col overflow-y-auto">
        <header class="sticky top-0 z-10 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-[#f4ece6] px-8 py-4 flex items-center justify-between">
            <div class="flex items-center gap-2 text-[#1c130d] dark:text-white text-sm">
                <span class="material-symbols-outlined text-xs text-[#9e6b47]">chevron_right</span>
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">
                    Update contact info and avatar from this page. Changing password uses the same validation rules as customers.
                </p>
            </div>
        </div>
        </div>
...
<div id="modalChangePassword" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
    <div class="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <form method="post" action="<%= ctx %>/admin/change-password" class="px-6 pb-6 space-y-4">
            <div class="space-y-1">
