...
<script>
    (function() {
        var toggle = document.getElementById('vet-queue-profile-toggle');
        var menu = document.getElementById('vet-queue-profile-menu');
