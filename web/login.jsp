...
<div class="flex flex-col lg:flex-row w-full min-h-screen">
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 md:p-24 bg-white dark:bg-background-dark">
        <div class="w-full max-w-[440px]">
            ...
            <!-- Google Login -->
            <a href="<%= request.getContextPath() %>/google-login" class="w-full h-12 flex items-center justify-center gap-3 border border-[#e2e8f0] dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors font-semibold text-[#181411] dark:text-white mb-8 no-underline">
