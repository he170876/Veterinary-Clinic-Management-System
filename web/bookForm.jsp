<%-- 
    ...
    Created on : Jan 29, 2026, 3:59:01 PM
    Author     : Admin
--%>
...
<style>
    ...
    .book-form-container .form-group {
        margin-bottom: 20px;
    }
    ...
    .book-form-container .form-select:focus {
        border-color: #f27c0d;
        box-shadow: 0 0 0 0.2rem rgba(242, 124, 13, 0.25);
    ...
    .book-form-container .form-row.full {
    ...
    .book-form-container .btn-submit {
        background: linear-gradient(135deg, #f27c0d 0%, #e07a0a 100%);
        color: white;
        padding: 12px 30px;
        border: none;
        border-radius: 8px;
    ...
    .book-form-container .btn-submit:hover {
        background: linear-gradient(135deg, #e07a0a 0%, #d96809 100%);
